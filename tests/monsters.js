	...
	describe('class', function() {
		...
		describe('to fail to instantiatiate with', function() {
			test.each([
				...
				['new with invalid xp', ()=>new Monster('1','testname','Fish','Funny','invalid',{health:1,attack:1,defense:1,speed:1}), 'invalid xp'],
				...
				['fromString with invalid xp', ()=>Monster.fromString('1,testname,Fish,Funny,invalid,health:1|attack:1|defense:1|speed:1'), 'invalid xp'],
